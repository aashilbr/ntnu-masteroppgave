...
if __name__ == '__main__':
    try:
        ...
        spawner.add_valve(x=0, y=-20, z=2, yaw=-pi/2)
        spawner.add_valve(x=5, y=-23, z=5, yaw=-pi/2)
        spawner.add_valve(x=0, y=-26, z=10, yaw=-pi/2)
        spawner.add_valve(x=-2, y=-24, z=5, yaw=-pi/4)
        #spawner.add_floor()
